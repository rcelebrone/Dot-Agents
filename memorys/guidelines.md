...
---
**Instrução para a Squad:** Sempre consulte e atualize este arquivo ao final de cada ciclo de desenvolvimento com restrições, sintaxe e padrões de desenvolvimento (não arquitetura, pois estas vão no arquivo `{{AGENTS_ROOT}}/memorys/architecture.md`) aprendidos.
